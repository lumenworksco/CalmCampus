...
> This is the **Flutter port** of the original [React Native / Expo version](../CalmCampus/).
...
- **Evidence-based micro-interventions** -- guided breathing exercises, mindfulness prompts, and grounding techniques
...
- **Campus resources integration** -- direct links to KU Leuven student support services
...
CalmCampusFlutter/
  lib/
    ...
    models/              # Data models (BehavioralSignal, DailyData)
    ...
    widgets/             # Reusable UI (BreathingExercise, SignalCard, TrendChart)
    data/                # Data engine and intervention content
    navigation/          # Tab scaffold and routing
    theme/               # Colors and Material theme definitions
...
- **No cloud storage.** All behavioral data is persisted locally via SharedPreferences.
...
Users own their data completely and can clear it at any time from the Profile screen.
